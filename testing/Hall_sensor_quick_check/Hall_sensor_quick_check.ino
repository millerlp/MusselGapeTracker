...
void setup() {
  ...
  Serial.println(F("Shift reg intialized"));
...
//  pinMode(MUX_S3, OUTPUT);
  Serial.println(F("Multiplexer started"));
  //----------------------------------
...
//  oldMillis = millis();
//  Serial.print(F("Starting millis: ")); Serial.println(oldMillis);
}
